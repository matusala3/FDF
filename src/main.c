...
/*   Updated: 2025/08/05 19:03:14 by magebreh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	gfx->win_ptr = mlx_new_window(gfx->mlx_ptr, WINDOW_WIDTH,
	...
	gfx->img_data = mlx_get_data_addr(gfx->img_ptr, &gfx->bits_per_pixel,
			&gfx->line_length, &gfx->endian);
	return (1);
}
